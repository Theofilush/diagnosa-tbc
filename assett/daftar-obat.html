	...
	<div class="container">
		...
		<div class="content">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" aria-current="page" style="color: #2D4468;"><i class="fas fa-pills"></i> Daftar Obat</li>
			...
			<div class="right-content">
				...
				<div class="hasil">
					<table class="table table-bordered table-hover">
				     ...
				     <tr>
				      <td scope="row">Gultamat apetsin klorida</td>
				      <td>Melegakan pernapasan dan menurunkan demam serta meredakan batuk yang tak kunjung sembuh.</td>
				    ...
				    <tr>
				     ...
				     <tr>
				      <td scope="row">Meloxinoid Omeplas</td>
				      <td>Melegakan pernapasan dan menurunkan demam serta meredakan batuk yang tak kunjung sembuh.</td>
